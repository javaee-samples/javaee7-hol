...
+
. Click on `Browse …' and select the directory that got created
when WildFly archive was unzipped. Click on `Next' and then `Finish'. 
The `Services' should show the WildFly instance.
+
